...
module.exports = {
	...
	async execute(ctx) {
		...
		if (exist) {
			...
			await createLocker(parsedss);
			console.log("Created Skins Image");
			if (fs.existsSync("./final/locker.png")) path = "./final/locker.png";
			else path = "./final/locker.jpeg";
